  ...
  },
  {
    ...
    reading: {
      vocabWarmup: {
        ...
        items: [
          { fi: 'haetaan', en: 'we are looking for' },
          { fi: 'työpaikka', en: 'job' },
          ...
          { fi: 'tehtävät', en: 'duties' },
          { fi: 'vaatimukset', en: 'requirements' },
          { fi: 'aikaisempi kokemus', en: 'previous experience' },
          { fi: 'suositukset', en: 'references' },
          { fi: 'työsuhde', en: 'employment' },
          { fi: 'määräaikainen', en: 'fixed-term' },
          { fi: 'vakituinen', en: 'permanent' },
          { fi: 'osa-aikainen', en: 'part-time' },
          { fi: 'kokoaikainen', en: 'full-time' },
          { fi: 'etätyö', en: 'remote work' },
          { fi: 'työmatka', en: 'commute' },
        ],
      },
      practicePassages: [
        {
      ...
      practicePassages: [
        {
          ...
          predictVocab: [
            ...
            { fi: 'työtehtävät', en: 'job duties' },
            { fi: 'kokemus', en: 'experience' },
            { fi: 'koulutus', en: 'education' },
            { fi: 'palkkatoive', en: 'salary expectation' },
            { fi: 'työaika', en: 'working hours' },
            { fi: 'työyhteisö', en: 'work community' },
            { fi: 'esihenkilö / pomo', en: 'supervisor / boss' },
            { fi: 'tiimi', en: 'team' },
            { fi: 'projekti', en: 'project' },
            { fi: 'palaveri / kokous', en: 'meeting' },
            { fi: 'työmatka', en: 'business trip' },
            { fi: 'urakehitys', en: 'career development' },
          ],
        },
      ],
      testPassages: [],
    ...
    vocabSummary: [
      ...
      { fi: 'työnantaja', en: 'employer' },
      { fi: 'työkaveri / kollega', en: 'colleague' },
      { fi: 'esihenkilö / pomo', en: 'supervisor/boss' },
      { fi: 'työhakemus', en: 'job application' },
      { fi: 'työhaastattelu', en: 'job interview' },
      { fi: 'ansioluettelo / CV', en: 'resume/CV' },
      { fi: 'palkka', en: 'salary' },
      { fi: 'työaika', en: 'working hours' },
      { fi: 'työsopimus', en: 'employment contract' },
      { fi: 'loma', en: 'vacation' },
      { fi: 'sairausloma', en: 'sick leave' },
      { fi: 'irtisanoutua', en: 'to resign' },
      { fi: 'irtisanominen', en: 'termination' },
      ...
      { fi: 'projekti', en: 'project' },
      { fi: 'palaveri / kokous', en: 'meeting' },
      { fi: 'koulutus (työssä)', en: '(job) training' },
      { fi: 'urakehitys', en: 'career development' },
      { fi: 'työterveys', en: 'occupational health' },
      { fi: 'työmatka', en: 'commute / business trip' },
    ],
    usefulPhrases: [
      { fi: 'Olen töissä...', en: 'I work at...' },
      { fi: 'Työskentelen...', en: 'I work as...' },
      { fi: 'Minulla on kokemusta...', en: 'I have experience in...' },
      { fi: 'Olen hakenut työtä...', en: 'I have applied for a job...' },
      { fi: 'Haluaisin hakea työpaikkaanne.', en: 'I would like to apply for your job.' },
      { fi: 'Milloin voin tulla haastatteluun?', en: 'When can I come for an interview?' },
      { fi: 'Olen sairas enkä pääse töihin.', en: "I am sick and can't come to work." },
      { fi: 'Haluaisin vaihtaa vuoroa.', en: 'I would like to change shifts.' },
      { fi: 'Paljonko palkka on?', en: 'How much is the salary?' },
      { fi: 'Millaisia työtehtäviä on?', en: 'What are the job duties?' },
      { fi: 'Onko työ määräaikainen vai vakituinen?', en: 'Is the job fixed-term or permanent?' },
      { fi: 'Tarvitsen työtodistuksen.', en: 'I need a work certificate.' },
      { fi: 'Olen kiinnostunut...', en: 'I am interested in...' },
      { fi: 'Hakemukseni on liitteenä.', en: 'My application is attached.' },
      { fi: 'Ansioluetteloni on liitteenä.', en: 'My CV is attached.' },
      { fi: 'Odotan innolla haastattelua.', en: 'I look forward to the interview.' },
      { fi: 'Toivottavasti kuulen pian teistä.', en: 'I hope to hear from you soon.' },
      { fi: 'Olen myöhässä.', en: 'I am late.' },
      { fi: 'Tulen kohta.', en: "I'll come soon." },
      { fi: 'Minulla on palaveri.', en: 'I have a meeting.' },
      { fi: 'Lounastauko on klo 12.', en: 'Lunch break is at 12.' },
      { fi: 'Tein työni valmiiksi.', en: 'I finished my work.' },
